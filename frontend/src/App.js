...
class App extends Component {
  ...
  onRoomCreate = (e) => {
    ...
    this.client = new W3CWebSocket('ws://35.232.55.46:8001/ws/' + this.state.room + '/'); //gets room_name from the state and connects to the backend server
